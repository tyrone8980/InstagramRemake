...
- [X] After the user submits a new post, show an indeterminate progress bar while the post is being uploaded to Parse (1 point)
...
<img src='https://github.com/tyrone8980/InstagramRemake/blob/master/instagramActivity.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
